    ...
    <Box>
      ...
      >
        ...
        <ExerciseDescription title="ЛЯГУШКА И КУЗНЕЧИК">
          ...
          <TextSpan type="var-red">N</TextSpan> клеток сидят лягушка и кузнечик:
          лягушка в клетке № 1, кузнечик в клетке №{" "}
          <TextSpan type="var-red">N</TextSpan>. Каждую секунду лягушка прыгает
          в сторону кузнечика, и одновременно кузнечик прыгает в сторону
          лягушки. Лягушка может прыгать только на две или на три клетки,
          кузнечик, только на одну или на две клетки. За какое наименьшее время
          они смогут оказаться в одной клетке?
        </ExerciseDescription>
        <DataFormats
          in={[
            {
        ...
        />
        <Solution>
          Расстояние между лягушкой и кузнечиком{" "}
          <TextSpan type="var-red">N</TextSpan> = 1 клеток. За одну секунду это
          расстояние может сократиться на 3, 4 или 5 клеток. Поэтому если{" "}
          <TextSpan type="var-red">N</TextSpan> − 1 = 1 или{" "}
          <TextSpan type="var-red">N</TextSpan> − 1 = 2 (то есть при{" "}
          <TextSpan type="var-red">N</TextSpan> {"<"} 4) лягушка и кузнечик не
          смогут встретиться и нужно вывести -1. Во всех остальных случаях им
        ...
        <ExerciseDescription title="Заказ в магазине">
          ...
          что ему нужно <TextSpan type="var-green">M</TextSpan> ручек. В его
          любимом интернет-магазине есть удобная функция - он может сразу
          добавить в заказ упаковку из любого числа ручек от 1 до{" "}
          <TextSpan type="var-red">N</TextSpan>. Правда, оказалось, что нельзя
          добавить в заказ две упаковки одного размера. Например, если Игорю
          нужно купить <TextSpan type="var-green">M</TextSpan> = 12 ручек, а
          максимальное число ручек в упаковке{" "}
          <TextSpan type="var-red">N</TextSpan> = 10, то Игорь может добавить в
          заказ упаковку из 7 ручек и упаковку из 5 ручек, но не сможет добавить
          две упаковки из 6 ручек. Сформируйте заказ на{" "}
          <TextSpan type="var-green">M</TextSpan> ручек, используя минимальное
          число различных упаковок.
        </ExerciseDescription>
        <DataFormats
          in={[
            {
        ...
        <Solution>
          ...
          ручек, которое можно заказать, равно 1 + 2 + 3 + ... +{" "}
          <TextSpan>N</TextSpan> = <TextSpan>N</TextSpan> (
          <TextSpan>N</TextSpan> + 1)/2 (по формуле суммы арифметической
          прогрессии), и если <TextSpan>M</TextSpan> {">"}{" "}
          <TextSpan>N</TextSpan> (<TextSpan>N</TextSpan> + 1)/2, то решения не
          существует. Если эту сумму вычислять не по формуле, а при помощи
          цикла, то цикл длины <TextSpan>N</TextSpan> можеть не уложиться в
          ограничение по времени. В этом случае стоит прервать цикл, если сумма
          превысит <TextSpan>M</TextSpan>, либо заметить, что если{" "}
          <TextSpan>N</TextSpan> {">"} √2 · 109 ≈ 44721, то 1 + 2 + 3 + ... +{" "}
          ...
          <TextSpan>N</TextSpan> − 1, <TextSpan>N</TextSpan> − 2 и т.д. Если
          размер рассматриваемой упаковки s больше или равен{" "}
          <TextSpan>M</TextSpan>, то выведем значение s и уменьшим{" "}
          <TextSpan>M</TextSpan> на s
        </Solution>
      </Chapter>
    </Box>
  );
