    ...
    <Box>
      ...
      <Paragraph title="5. ПРОЦЕДУРЫ И ФУНКЦИИ" id="functions">
        ...
        <SubPara>
          ...
          <Span>return</Span>. В Питоне принято писать в таком случае слово{" "}
          <Span>pass</Span>:
        </SubPara>
        <CodeSection>
          <CodeLine>
      ...
      <Paragraph title="7. ОПЕРАТОРЫ ЦИКЛА" id="cycles">
        ...
        <SubPara>
          ...
          вручную писать команду <Span>print</Span> для каждого числа, можно
        ...
        <SubPara>
          ...
          передаем с встроенной функцией <Span>range</Span>:
        </SubPara>
        <CodeSection>
          <CodeLine>
      ...
      <Paragraph title="8. СИНТАКСИС PYTHON" id="syntax">
        ...
        <SubPara>
          ...
          ним надо поставить хэштег (<Span type="highlight bold">#</Span>),
      ...
      <Paragraph title="10. БИБЛИОТЕКИ PYTHON" id="libraries">
        ...
        <SubPara>
          1. <Span type="highlight bold">collections</Span> - Эта библиотека
        ...
        <SubPara>
          4. <Span type="highlight bold">re</Span> - Эта библиотека
