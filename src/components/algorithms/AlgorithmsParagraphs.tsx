  ...
  return (
    <Box>
      ...
      <Paragraph title="8. ЭВРИСТИЧЕСКИЕ МЕТОДЫ" id="heuristic-methods">
        <SubPara>
          Эвристический алгоритм — это алгоритм решения задачи, правильность
        ...
        <SubPara>
          Важно понимать, что эвристика, в отличие от корректного алгоритма
          решения задачи, обладает следующими особенностями:
        </SubPara>
      </Paragraph>
      <Paragraph title="9. HASH-ТАБЛИЦЫ И HASH-ФУНКЦИИ" id="hashmap">
        <SubPara>
      ...
      >
        <SubPara>
          ...
          инструментом для решения многих сложных задач. В этом введении мы
          рассмотрим основные принципы динамического программирования и обсудим
          некоторые из его ключевых применений в таких областях, как
          компьютерные науки, экономика и инженерия.
        </SubPara>
      </Paragraph>
    </Box>
  );
